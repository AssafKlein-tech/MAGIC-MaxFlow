...
static void
readDimacsFileCreateList (char * filename) 
{
	printf("Reading dimacs file...\n");
	uint lineLength=2048, i, capacity, numLines = 0, from, to, first=0, last=0;
...
main(int argc, char ** argv) 
{
	...
	writeTime(argv[2], solveEnd - solveStart, numNodes);
